...
int main(int argc, char* argv[])
{
    ...
    int num_of_leave = num_of_players; // количество карт слиняй
    int num_of_future = num_of_players; //количество карт "посмотреть в будущее"
    int num_of_norm = num_of_cards - num_of_boom - num_of_defuse - num_of_future - num_of_leave; // количество карт без действия пока в колоде
    ...
    create.create_card_future(num_of_future, deck); //создаем карты просмотра в будущее
    create.create_card_leave(num_of_leave, deck); //создаем карты слиняй
